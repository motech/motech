...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationPlatformCommonBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/common";
    ...
    public static class CommonApplicationContext extends OsgiBundleXmlWebApplicationContext {
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(CommonApplicationContext.class);
