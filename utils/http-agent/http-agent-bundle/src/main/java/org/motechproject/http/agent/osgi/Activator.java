...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationContextHttpAgentBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/http-agent";
    ...
    public static class HttpAgentApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public HttpAgentApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(HttpAgentApplicationContext.class);
