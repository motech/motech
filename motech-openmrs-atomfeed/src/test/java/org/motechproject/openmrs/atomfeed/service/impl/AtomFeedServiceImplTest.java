...
public class AtomFeedServiceImplTest {
    ...
    public void shouldSetLastUpdateTimeAndIdToLastEntry() throws IOException {
        ...
        verify(atomFeedDao).setLastUpdateTime("urn:uuid:64f6f0e2-1acc-4a00-8a54-6adcd8cbfdfc", "2012-07-02T17:00:00-04:00");
    }
    ...
    public void shouldOnlySkipFirstEntryOnTimeAndIdMatch() throws IOException {
        when(client.getOpenMrsAtomFeedSinceDate(anyString())).thenReturn(readXmlFile("multiple-patient-updates.xml"));
