...
VALUES
--(1,'Immediate Notification Task','Task to send out immediate SMS notifications','org.motechproject.server.omod.tasks.NotificationTask','2010-08-17 06:29:20',NULL,300,1,0,1,'2011-09-27 15:07:00',NULL,NULL,'01b53896-edb4-11e0-a93d-196096cf4d13',NULL),
--(2,'Daily Notification Task','Task to send out SMS notifications for next day','org.motechproject.server.omod.tasks.NotificationTask','2010-08-17 23:00:00',NULL,86400,1,0,1,'2011-09-27 15:07:00',NULL,NULL,'01b53c24-edb4-11e0-a93d-196096cf4d13',NULL),
--(3,'MessageProgram Update Task','Task to update message program state for patients','org.motechproject.server.omod.tasks.MessageProgramUpdateTask','2010-08-17 06:31:40',NULL,180,1,0,1,'2011-09-27 15:07:00',NULL,NULL,'01b53d96-edb4-11e0-a93d-196096cf4d13',NULL),
--(4,'Daily Nurse Care Messaging Task','Task to send out staff SMS care messages for day','org.motechproject.server.omod.tasks.StaffCareMessagingTask','2010-08-17 23:20:00',NULL,86400,0,0,1,'2011-09-27 15:07:00',NULL,NULL,'01b53efe-edb4-11e0-a93d-196096cf4d13',NULL),
--(5,'Weekly Nurse Care Messaging Task','Task to send out staff SMS care messages for week','org.motechproject.server.omod.tasks.StaffCareMessagingTask','2010-08-15 23:40:00',NULL,604800,0,0,1,'2011-09-27 15:07:00',NULL,NULL,'01b5405c-edb4-11e0-a93d-196096cf4d13',NULL),
--(6,'Weekly EDD Nurse Care Messaging Task','Task to send out staff EDD SMS care messages for week','org.motechproject.server.omod.tasks.StaffCareMessagingTask','2010-08-15 23:40:00',NULL,604800,0,0,1,'2011-09-27 15:07:07',NULL,NULL,'01b541ba-edb4-11e0-a93d-196096cf4d13',NULL),
(7,'Update Concept Index','Iterates through the concept dictionary, re-creating the concept index (which are used for searcing). This task is started when using the \'Update Concept Index Storage\' page and no range is given.  This task stops itself when one iteration has completed.','org.openmrs.scheduler.tasks.ConceptIndexUpdateTask',NULL,NULL,0,1,1,1,'2005-01-01 00:00:00',NULL,'2011-10-03 17:08:45','7c75911e-0310-11e0-8222-18a905e044dc',NULL),
(8,'Initialize Logic Rule Providers',NULL,'org.openmrs.logic.task.InitializeLogicRuleProvidersTask','2011-10-03 17:09:15',NULL,1999999999,0,1,NULL,NULL,NULL,NULL,'f8753700-b900-45e1-a797-4a6a3b7424a8',NULL);
