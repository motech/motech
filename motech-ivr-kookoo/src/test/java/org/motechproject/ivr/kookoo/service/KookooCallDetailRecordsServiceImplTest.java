...
public class KookooCallDetailRecordsServiceImplTest {
    ...
    public void shouldUpdateTheEndDateWhenClosingCallDetailRecord() {
        KookooCallDetailRecordsServiceImpl kookooCallDetailRecordsService = new KookooCallDetailRecordsServiceImpl(allKooKooCallDetailRecords, eventService);
        ...
        kookooCallDetailRecordsService.close("callId", "externalId");
