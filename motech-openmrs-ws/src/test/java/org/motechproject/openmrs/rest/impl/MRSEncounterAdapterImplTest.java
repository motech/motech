...
public class MRSEncounterAdapterImplTest {
    ...
    @Test
    public void shouldSendCorrectJson() throws HttpException, JsonProcessingException, IOException {
        DateMidnight date = new DateMidnight(2012, 6, 1);
