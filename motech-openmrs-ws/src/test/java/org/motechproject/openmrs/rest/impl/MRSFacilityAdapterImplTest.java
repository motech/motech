...
public class MRSFacilityAdapterImplTest {
    ...
    @Test
    public void shouldNotIncludeUuidOnCreate() throws JsonProcessingException, IOException, HttpException {
        String emptyObject = "{}";
    ...
    @Test
    public void shouldSendCorrectLocationJson() throws HttpException, JsonProcessingException, IOException {
        String emptyObject = "{}";
