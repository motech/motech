...
/**
 * Provides utility methods for deleting/creating OpenMRS entities that are
...
public class AdapterHelper {
    ...
    protected void deleteFacility(MRSFacility facility) {
        restOperations.delete(openmrsUrl + "/ws/rest/v1/location/{uuid}", facility.getId() + "?purge");
    }

    protected void deletePatient(MRSPatient patient) {
        restOperations.delete(openmrsUrl + "/ws/rest/v1/patient/{uuid}", patient.getId() + "?purge");
    }
