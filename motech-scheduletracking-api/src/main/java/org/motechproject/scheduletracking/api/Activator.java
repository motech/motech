...
public class Activator implements BundleActivator {
    ...
    public static class ScheduleTrackingApiApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public ScheduleTrackingApiApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(ScheduleTrackingApiApplicationContext.class);
