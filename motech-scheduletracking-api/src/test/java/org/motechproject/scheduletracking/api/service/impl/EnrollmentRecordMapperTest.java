...
public class EnrollmentRecordMapperTest {
    ...
    public void shouldMapEnrollmentToEnrollmentResponse(){
        final Enrollment enrollment = new Enrollment("externalId", "scheduleName", "milestoneX", DateUtil.newDateTime(2000, 2, 1, 0, 0, 0), DateUtil.newDateTime(2000, 2, 10, 0, 0, 0), new Time(10, 10), null);
    ...
    public void shouldMapEnrollmentToEnrollmentResponseAndPopulateWindowDates(){
        Enrollment enrollment = new Enrollment("external_id_1", "schedule_1", "milestoneX", null, null, null, null);
