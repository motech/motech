...
public class ScheduleTrackingServiceImplTest {
    ...
    public void shouldUnenrollEntityFromTheSchedule() {
        ...
        String externalId = "entity_1";
        Enrollment enrollment = new Enrollment("entity_1", schedule, "milestone", weeksAgo(4), weeksAgo(4), new Time(8, 10), EnrollmentStatus.ACTIVE);
        when(allEnrollments.getActiveEnrollment("entity_1", "my_schedule")).thenReturn(enrollment);
    ...
    public void shouldSafelyUnenrollEntityFromListOfSchedule() {
        ...
        String externalId = "entity_1";
        Enrollment enrollment1 = new Enrollment(externalId, schedule1, "milestone1", weeksAgo(4), weeksAgo(4), new Time(8, 10), EnrollmentStatus.ACTIVE);
        when(allEnrollments.getActiveEnrollment(externalId, schedule1Name)).thenReturn(enrollment1);
        Enrollment enrollment2 = new Enrollment(externalId, schedule2, "milestone2", weeksAgo(4), weeksAgo(4), new Time(8, 10), EnrollmentStatus.ACTIVE);
    ...
    public void shouldReturnEnrollmentDetails() {
        ...
        final Enrollment enrollment = new Enrollment(externalId, schedule, null, null, null, null, EnrollmentStatus.ACTIVE);
    ...
    public void shouldReturnListOfEnrollmentRecordsForTheGivenQuery() {
        Schedule schedule = new Schedule("some_schedule");
        EnrollmentsQuery enrollmentQuery = mock(EnrollmentsQuery.class);
        Enrollment enrollment1 = new Enrollment("external_id_1", schedule, null, null, null, null, null);
        Enrollment enrollment2 = new Enrollment("external_id_2", schedule, null, null, null, null, null);
        List<Enrollment> enrollments = asList(new Enrollment[]{enrollment1, enrollment2});
