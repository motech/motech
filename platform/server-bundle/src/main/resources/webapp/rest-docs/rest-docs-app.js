(function () {
    ...
    restDocModule.controller('ServerRestDocsCtrl', function ($scope, $location, $http, ModalServ) {
        ...
        $http.get("../server/module/rest-docs/" + $scope.getRestModuleName()).success(function(data) {
            ...
            window.swaggerUi = new SwaggerUi({
                ...
                onFailure: function(data) {
                    ModalServ.motechAlert(data, "error");
                },
                onComplete: function() {
        ...
        }).error(ModalServ.alertHandler('server.error', 'server.error.rest.url'));
    });
