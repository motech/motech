...
public class ConfigurationFileMonitor implements FileListener {
    ...
    @Autowired
    public ConfigurationFileMonitor(ConfigLocationFileStore configLocationFileStore, ConfigurationService configurationService)
    ...
    public static void main(String[] args) throws FileSystemException, InterruptedException {
        ConfigurationFileMonitor configurationFileMonitor = new ConfigurationFileMonitor();
        configurationFileMonitor.init();
        Thread.sleep(60*1000);
    }

    public ConfigurationFileMonitor() {
        this.fileMonitor = new DefaultFileMonitor(this);
    }

    @PostConstruct
    public void init() throws FileSystemException {
        final String path = configLocationFileStore.getPath();
        FileObject monitoredDir = VFS.getManager().resolveFile(path);
    ...
    public void fileCreated(FileChangeEvent fileChangeEvent) throws IOException {
        ...
        //configurationService.updateProperties(null, fileName, null, null);
    }
