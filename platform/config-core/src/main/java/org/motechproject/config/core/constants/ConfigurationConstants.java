...
public final class ConfigurationConstants {
    ...
    public static final String PASSWORD_REMINDER = "security.password.reminder";
    public static final String PASSWORD_REMINDER_DAYS = "security.password.reminder.days";
