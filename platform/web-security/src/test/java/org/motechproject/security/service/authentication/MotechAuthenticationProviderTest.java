...
public class MotechAuthenticationProviderTest {
    ...
    public void setup() {
        initMocks(this);
        authenticationProvider = new MotechAuthenticationProvider(motechUsersDao, passwordEncoder, authoritiesService, settingService);
    }
    ...
    public void shouldThrowExceptionIfUserDoesntExist() {
        when(motechUsersDao.findByUserName("bob")).thenReturn(null);
