(function () {
    ...
    */
    directives.directive('entityInstancesBrowserGrid', function ($timeout, $http, ModalServ) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
    ...
    * Displays related instances data using jqGrid
    */
    directives.directive('entityRelationsGrid', function ($timeout, $http, MDSUtils, ModalServ) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
