    ...
    */
    controllers.controller('MdsSchemaEditorCtrl', function ($scope, $timeout, $http, Entities, MDSUsers, Permissions, MDSUtils, Locale) {
        ...
        */
        ...
        $scope.securityOptions = ['EVERYONE', 'OWNER', 'CREATOR', 'USERS', 'PERMISSIONS', 'NONE'];
    ...
    controllers.controller('MdsDataBrowserCtrl', function ($rootScope, $scope, $http, $location, $routeParams, Entities, Instances, History,
            ...
            $http.get('../mds/entities/byModule').success(function (data) {
                angular.forEach(data, function (entitiesList, moduleName) {
                    ...
                    angular.forEach(entitiesList, function (entity) {
                        ...
                        $scope.entitiesByReadOnlyAccess[entity.name] = entity.hasOnlyReadAccessToInstance;
                    });
                });
        ...
        */
        ...
        $scope.shouldHideEdition = function(field) {
            return field.nonEditable || $scope.previousInstance || $scope.isAutoGenerated(field) || ($scope.selectedEntity !== null && ($scope.selectedEntity.nonEditable || $scope.selectedEntity.hasOnlyReadAccessToInstance));
        };
