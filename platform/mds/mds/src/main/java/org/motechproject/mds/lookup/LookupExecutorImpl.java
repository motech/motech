...
public class LookupExecutorImpl implements LookupExecutor {
    ...
    public LookupExecutorImpl(MotechDataService dataService, LookupDto lookup, Map<Long, FieldDto> fieldsById) {
