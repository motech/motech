...
public class LookupExecutor {
    ...
    public LookupExecutor(MotechDataService dataService, LookupDto lookup, List<FieldDto> fields) {
        this(dataService, lookup, FieldHelper.asFieldMapById(fields));
    }
    ...
    public Object execute(Map<String, Object> lookupMap) throws LookupExecutorException {
        return execute(lookupMap, null);
    }

    public Object execute(Map<String, Object> lookupMap, QueryParams queryParams) throws LookupExecutorException {
    ...
    public long executeCount(Map<String, Object> lookupMap) throws LookupExecutorException {
        List<Object> args = getLookupArgs(lookupMap);
        List<Class> argTypes = buildArgTypes();
    ...
    private List<Object> getLookupArgs(Map<String, Object> paramMap) {
