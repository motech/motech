        ...
        <c:choose>
            <c:when test="${redirect}">
                <div class="margin-before margin-after loadingbar">
                    ...
                    <br/>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-osgi-web-util"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform OSGi Web Util</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-config-core"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Config Core</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-commons-sql"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Commons SQL</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-event"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Event</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-dataservices"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Data Services</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-server-config"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Server Config</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-email"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Email</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-web-security"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Web Security</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-server-bundle"><i class="fa fa-spinner fa-2x"></i><i class="fa fa-check-circle fa-2x"></i><i class="fa fa-times-circle fa-2x"></i> MOTECH Platform Server Bundle</div>
