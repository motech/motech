        ...
        <c:choose>
            <c:when test="${redirect}">
                <div class="margin-before margin-after loadingbar" ng-cloak>
                    ...
                    <div class="loading-text-block first" id="loading-org.motechproject.motech-platform-osgi-web-util"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform OSGi Web Util</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-config-core"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Config Core</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-commons-sql"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Commons SQL</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-event"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Event</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-dataservices"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Data Services</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-server-config"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Server Config</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-email"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Email</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-web-security"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Web Security</div>
                    <div class="loading-text-block" id="loading-org.motechproject.motech-platform-server-bundle"><img class="circle-loader" src="../../static/common/img/circle-loader.gif"><img class="circle-loader-spinner" src="../../static/common/img/circle-loader-spinner.gif"><i class="fa fa-check-circle fa-lg icon-green icon-green"></i><i class="fa fa-times-circle fa-lg icon-red"></i> MOTECH Platform Server Bundle</div>
                        ...
                        <form action="#" method="POST" class="form-horizontal bootstrap-config-form col-sm-12" name="bcform">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input class="btn btn-success" type="submit" name="BOOTSTRAP" ng-disabled="bcform.sqlUrl.$error.required || bcform.sqlDriver.$error.required || bcform.OsgiFrameworkStorage.$error.required || bcform.queueUrl.$error.required" onclick="submitForm()" value="<spring:message code="server.bootstrap.submit"/>"/>
                                </div>
                            </div>
