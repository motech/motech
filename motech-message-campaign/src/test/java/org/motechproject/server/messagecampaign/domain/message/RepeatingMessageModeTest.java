...
public class RepeatingMessageModeTest extends BaseUnitTest {
    ...
    public void shouldCheckHasEnded_IfNextToCurrentApplicableDateTimeIsBeyondEndTime() {
        ...
        Date sat11Feb2012EndDate = date("11-Feb-2012 12:11:20 Sat");
        ...
        //before 10:30
        mockCurrentDate(new DateTime(date("8-Feb-2012 06:11:10 Wed")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("9-Feb-2012 06:11:10 Thu")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("10-Feb-2012 06:11:10 Fri")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("11-Feb-2012 06:11:10 Sat")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        //after 10:30
        mockCurrentDate(new DateTime(date("8-Feb-2012 11:11:10 Wed")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("9-Feb-2012 11:11:10 Thu")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("10-Feb-2012 11:12:10 Fri")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("11-Feb-2012 11:11:10 Sat")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));
    }
    ...
    public void shouldCheckHasEnded_IfNextToCurrentApplicableDateTimeIsBeyondEndTime_AndNowIsWithin_10_30_Range() {
        ...
        mockCurrentDate(new DateTime(date("9-Feb-2012 10:30:00 Thu")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("10-Feb-2012 10:30:00 Fri")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        // < 10:30
        mockCurrentDate(new DateTime(date("9-Feb-2012 10:29:59 Thu")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("10-Feb-2012 10:29:59 Fri")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        // > 10:30
        mockCurrentDate(new DateTime(date("9-Feb-2012 10:30:01 Thu")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("10-Feb-2012 10:30:01 Fri")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        // wed and satruday
        mockCurrentDate(new DateTime(date("8-Feb-2012 10:30:10 Wed")));
        assertFalse(cwSchedule.hasEnded(message, sat11Feb2012EndDate));

        mockCurrentDate(new DateTime(date("11-Feb-2012 10:30:00 Sat")));
        assertTrue(cwSchedule.hasEnded(message, sat11Feb2012EndDate));
    ...
    public void shouldReturnIsEndedForWeekSchedule_IfNextToCurrentApplicableDateIsBeyondEndDate(){
        ...
        Date sat17Feb2012EndDate = date("17-Feb-2012 22:11:20 Fri");

        mockCurrentDate(new DateTime(date("14-Feb-2012 12:00:00 Mon")));
        assertFalse(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("14-Feb-2012 12:00:00 Tue")));
        assertFalse(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("15-Feb-2012 12:00:00 Wed")));
        assertTrue(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("17-Feb-2012 22:11:20 Fri")));
        assertTrue(weekSchedule.hasEnded(message, sat17Feb2012EndDate));
    }
    ...
    public void shouldReturnIsEndedForRepeatInterval_IfNextToCurrentApplicableDateIsBeyondEndDate(){
        ...
        mockCurrentDate(new DateTime(date("7-Feb-2012 12:00:00")));
        assertFalse(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("8-Feb-2012 12:00:00")));
        assertFalse(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("9-Feb-2012 12:00:00")));
        assertFalse(weekSchedule.hasEnded(message, sat17Feb2012EndDate));

        mockCurrentDate(new DateTime(date("17-Feb-2012 12:00:00")));
        assertTrue(weekSchedule.hasEnded(message, sat17Feb2012EndDate));
