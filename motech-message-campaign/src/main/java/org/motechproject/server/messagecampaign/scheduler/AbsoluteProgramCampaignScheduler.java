...
public class AbsoluteProgramCampaignScheduler implements MessageCampaignScheduler {

    private MotechSchedulerService schedulerService;
    private EnrollForAbsoluteProgramRequest enrollRequest;

    public AbsoluteProgramCampaignScheduler(MotechSchedulerService schedulerService,
