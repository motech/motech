...
entity class name and lookup name combination. This is intended way for modules to define lookups that should be made
editable by the end user. Backend code should not depend on these lookups.
