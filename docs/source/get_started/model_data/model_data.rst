...
in the database table. MDS supports multiple :std:ref:`fields types <field_types>`.
...
model for their application. Entities defined in this way will be treated in a similar fashion to EUDE_ entitiess, they can also
