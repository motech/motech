...
public class PillRegimenBuilder {
    ...
    public PillRegimen createFrom(PillRegimenRequest pillRegimenRequest) {
        ...
        return new PillRegimen(pillRegimenRequest.getExternalId(), pillRegimenRequest.getStartDate(), pillRegimenRequest.getEndDate(), pillRegimenRequest.getReminderRepeatWindowInHours(), pillRegimenRequest.getReminderRepeatIntervalInMinutes(), dosages);
    }
}
