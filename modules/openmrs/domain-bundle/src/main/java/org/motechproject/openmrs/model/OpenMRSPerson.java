 ...
 */
public class OpenMRSPerson implements MRSPerson {
    ...
    public OpenMRSPerson addAttribute(MRSAttribute attribute) {
        attributes.add(attribute);
        return this;
    }

    public OpenMRSPerson attributes(List<MRSAttribute> attributes) {
    ...
    public String attrValue(String key) {
        List<MRSAttribute> filteredItems = select(attributes, having(on(MRSAttribute.class).getName(), equalTo(key)));
