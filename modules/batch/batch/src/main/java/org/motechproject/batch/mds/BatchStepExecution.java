...
public class BatchStepExecution implements java.io.Serializable {
	...
	public BatchStepExecution(long stepExecutionId, String stepName,
			long jobExecutionId, Date startTime, Date endTime, String status,
			Long commitCount, Long readCount, Long filterCount,
			Long writeCount, Long readSkipCount, Long writeSkipCount,
			Long processSkipCount, Long rollbackCount, String exitCode,
			String exitMessage, Date lastUpdated, String createdBy,
