...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationDecisionTreeCommonBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/tree-common";
