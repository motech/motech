...
/**
 * A logging service manager that allows for registration of logging services. This class is exposed as an OSGi service to
 * support cross-bundle registration.
 */
public interface EventLoggingServiceManager {

    /**
     * Register a logging service in the platform, which will generate listeners for that logging service based on the
     * subjects it listens on.
     *
