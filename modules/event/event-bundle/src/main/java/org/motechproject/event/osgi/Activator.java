...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationMotechEventBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/event";
    ...
    public static class EventApplicationContext extends OsgiBundleXmlWebApplicationContext {
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(EventApplicationContext.class);
