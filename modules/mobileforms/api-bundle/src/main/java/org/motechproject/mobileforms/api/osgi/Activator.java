...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationMobileFormsAPIBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/mobileformsapi";
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(MobileFormsApiApplicationContext.class);
