...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "META-INF/osgi/applicationAdminUIBundle.xml";
    ...
    public static class AdminUIApplicationContext extends MotechOsgiWebApplicationContext {
    ...
    private void serviceAdded(UIFrameworkService service) {
        ...
        logger.debug("Admin registered in UI framework");
    }

    private void serviceRemoved(UIFrameworkService service) {
        service.unregisterModule(MODULE_NAME);
        logger.debug("Admin unregistered from UI framework");
    }
}
