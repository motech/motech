...
public class MavenRepositorySystemSession
    ...
    private static final String STR_JAR = "jar";
    private static final String STR_WAR = "war";
    private static final String STR_EAR = "ear";
    ...
    public MavenRepositorySystemSession() {
        ...
        stereotypes.add(new DefaultArtifactType("maven-plugin", STR_JAR, "", STR_JAVA));
        stereotypes.add(new DefaultArtifactType(STR_JAR, STR_JAR, "", STR_JAVA));
        stereotypes.add(new DefaultArtifactType("ejb", STR_JAR, "", STR_JAVA));
        stereotypes.add(new DefaultArtifactType("ejb-client", STR_JAR, "client", STR_JAVA));
        stereotypes.add(new DefaultArtifactType("test-jar", STR_JAR, "tests", STR_JAVA));
        stereotypes.add(new DefaultArtifactType("javadoc", STR_JAR, "javadoc", STR_JAVA));
        stereotypes.add(new DefaultArtifactType("java-source", STR_JAR, "sources", STR_JAVA, false, false));
        stereotypes.add(new DefaultArtifactType(STR_WAR, STR_WAR, "", STR_JAVA, false, true));
        stereotypes.add(new DefaultArtifactType(STR_EAR, STR_EAR, "", STR_JAVA, false, true));
        stereotypes.add(new DefaultArtifactType("rar", "rar", "", STR_JAVA, false, true));
        stereotypes.add(new DefaultArtifactType("par", "par", "", STR_JAVA, false, true));
