 ...
 * a matching {@link org.motechproject.admin.domain.StatusMessage} is registered in the system. The message is
 * matched against its level and the module to which it is tied to.
