...
public interface StatusMessagesDataService extends MotechDataService<StatusMessage> {
     ...
     * result in retrieving in all messages timing out before the max value. Leaving the max value empty will result
     * int retrieving all messages timing out after the min value.
