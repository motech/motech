...
public class AllTasksIT extends SpringIntegrationTest {
    ...
    public void shouldAddAndUpdateTask() {
        TaskActionInformation action = new TaskActionInformation("test", "test", "test", "0.15", "SEND");
        TaskEventInformation trigger = new TaskEventInformation("test", "test", "test", "0.14", "RECEIVE");
