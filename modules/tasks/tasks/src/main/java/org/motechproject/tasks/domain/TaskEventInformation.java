...
public class TaskEventInformation implements Serializable {
    ...
    public TaskEventInformation(String channelName, String moduleName, String moduleVersion, String subject) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(channelName, moduleName, moduleVersion, subject);
    }
    ...
    public String toString() {
        return String.format("TaskEventInformation{channelName='%s', moduleName='%s', moduleVersion='%s', subject='%s'}",
                channelName, moduleName, moduleVersion, subject);
    }
}
