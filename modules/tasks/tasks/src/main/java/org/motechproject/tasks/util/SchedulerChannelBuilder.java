...
@Component
public class SchedulerChannelBuilder {

    private static final Logger LOGGER = LoggerFactory.getLogger(SchedulerChannelBuilder.class);
    ...
    @Autowired
    public SchedulerChannelBuilder(BundleContext bundleContext, ChannelService channelService) {
