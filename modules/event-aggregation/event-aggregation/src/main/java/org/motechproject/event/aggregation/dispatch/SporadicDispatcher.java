...
public class SporadicDispatcher {
    ...
    public void handle(MotechEvent event) {
        ...
        AggregationRule aggregationRule = dispatchEvent.getAggregationRule();
        List<? extends AggregatedEvent> aggregatedEvents = allAggregatedEvents.findByAggregationRule(aggregationRule.getName());
