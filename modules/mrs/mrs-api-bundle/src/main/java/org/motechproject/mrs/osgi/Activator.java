...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationMrsAPIBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/mrsapi";
    ...
    public static class MrsApiApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public MrsApiApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(MrsApiApplicationContext.class);
