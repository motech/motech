...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationContextAlertBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/alertsapi";
    ...
    public static class AlertsApiApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public AlertsApiApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(AlertsApiApplicationContext.class);
