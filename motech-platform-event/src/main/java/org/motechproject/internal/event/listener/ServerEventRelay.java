package org.motechproject.internal.event.listener;
...
public class ServerEventRelay implements EventRelay {
    ...
    public ServerEventRelay(EventQueueGateway eventQueueGateway, EventListenerRegistry eventListenerRegistry, MetricsAgent metricsAgent) {
    ...
    private void splitEvent(MotechEvent event, Set<EventListener> listeners) {
        ...
        for (EventListener listener : listeners) {
            ...
            eventQueueGateway.sendEventMessage(enrichedEventMessage);
        }
    }
