...
import org.motechproject.internal.event.listener.ServerEventRelay;
...
public class ServerEventRelayIT {
    ...
    public void setUp() throws Exception {
        ...
        registry = new EventListenerRegistryImpl(metricsAgent);
        eventRelay = new ServerEventRelay(eventQueueGateway, registry, metricsAgent);
    ...
    public void testSplittingRelay() throws Exception {
        ...
        verify(eventQueueGateway, times(2)).sendEventMessage(argument.capture());
