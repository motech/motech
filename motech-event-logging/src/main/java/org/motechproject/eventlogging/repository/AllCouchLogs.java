...
public class AllCouchLogs extends MotechBaseRepository<CouchEventLog> {
    ...
    @Autowired
    protected AllCouchLogs(
            @Qualifier("eventLoggingDBConnector") CouchDbConnector db) {
    ...
    public List<CouchEventLog> findAllByParameter(String parameter, String value) {
        List<CouchEventLog> logs = queryView("find_by_parameter",
                ComplexKey.of(parameter, value));
        return logs;
    }
    ...
    public List<CouchEventLog> findAllBySubjectAndParameter(String subject,
            String parameter, String value) {
        List<CouchEventLog> logs = queryView("find_by_subject_and_parameter",
                ComplexKey.of(subject, parameter, value));
        return logs;
    }
