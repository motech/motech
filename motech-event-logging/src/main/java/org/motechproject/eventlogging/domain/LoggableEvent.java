...
public class LoggableEvent {
    ...
    public LoggableEvent(List<String> eventSubjects, List<? extends EventFlag> flags2) {
        if (eventSubjects == null) {
            this.eventSubjects = new ArrayList<String>();
        } else {
            this.eventSubjects = eventSubjects;
        }
        if (flags2 == null) {
            this.flags = new ArrayList<EventFlag>();
        } else {
            this.flags = flags2;
        }
    }
    ...
    private boolean checkWildCardMatch(MotechEvent eventToLog,
            String eventSubject) {
