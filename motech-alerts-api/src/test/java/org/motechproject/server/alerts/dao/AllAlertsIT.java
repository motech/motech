...
public class AllAlertsIT {
    ...
    public void shouldReturnAllAlertsWithGivenExternalIdOnly() {
        createAlert("included_entity", AlertType.HIGH, AlertStatus.CLOSED, 3, null);
        createAlert("excluded_entity", AlertType.LOW, AlertStatus.CLOSED, 8, null);
        createAlert("included_entity", AlertType.LOW, AlertStatus.NEW, 2, null);
    ...
    public void shouldReturnAllAlertsWithGivenAlertTypeOnly() {
        createAlert("entity1", AlertType.HIGH, AlertStatus.CLOSED, 3, null);
        createAlert("entity2", AlertType.LOW, AlertStatus.CLOSED, 8, null);
        createAlert("entity3", AlertType.LOW, AlertStatus.NEW, 2, null);
    ...
    public void shouldReturnAllAlertsWithGivenPriorityOnly() {
        createAlert("entity1", AlertType.HIGH, AlertStatus.CLOSED, 1, null);
        createAlert("entity2", AlertType.LOW, AlertStatus.CLOSED, 3, null);
        createAlert("entity3", AlertType.LOW, AlertStatus.NEW, 2, null);
    ...
    public void shouldReturnAllAlertsWithoutAnyFilter() {
        createAlert("111", AlertType.HIGH, AlertStatus.NEW, 2, null);
        createAlert("222", AlertType.CRITICAL, AlertStatus.CLOSED, 1, null);
    ...
    public void shouldFilterAlertsBasedOnExternalId() {
        Alert alert1 = createAlert("111", AlertType.HIGH, AlertStatus.NEW, 2, null);
        Alert alert2 = createAlert("222", AlertType.CRITICAL, AlertStatus.CLOSED, 1, null);
    ...
    public void shouldFindAlertsWithOneOrMoreMatchingFilterCriteria() {
        Alert alert1 = createAlert("111", AlertType.HIGH, AlertStatus.NEW, 2, null);
        Alert alert2 = createAlert("222", AlertType.CRITICAL, AlertStatus.CLOSED, 1, null);
        Alert alert3 = createAlert("111", AlertType.CRITICAL, AlertStatus.NEW, 1, null);
    ...
    private Alert createAlert(String externalId, AlertType alertType, AlertStatus alertStatus, int priority, Map<String, String> data) {
