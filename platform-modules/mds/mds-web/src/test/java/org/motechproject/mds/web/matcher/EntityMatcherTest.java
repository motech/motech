...
public class EntityMatcherTest {
    ...
    private void matchEntities(String term, int matchedCount, int noMatchedCount) {
        ...
        Assert.assertEquals("The number of matched entities is incorrect", matchedCount, trueCount);
        Assert.assertEquals("The number of no matched entities is incorrect", noMatchedCount, falseCout);
    }
