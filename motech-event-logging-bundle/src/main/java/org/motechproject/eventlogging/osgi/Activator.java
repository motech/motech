...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "applicationEventLoggingBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/eventlogging";
    ...
    public static class EventLoggingApplicationContext extends OsgiBundleXmlWebApplicationContext {

        public EventLoggingApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(EventLoggingApplicationContext.class);
