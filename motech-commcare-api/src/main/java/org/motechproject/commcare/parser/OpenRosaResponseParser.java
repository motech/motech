...
public class OpenRosaResponseParser {
    ...
    public OpenRosaResponse parseResponse(String response) throws CaseParserException {
        ...
        Element openRosaElement = (Element) document.getElementsByTagName("OpenRosaResponse").item(0);
